...
html_logo = '_static/imgs/pyforms-small.jpg'
...
latex_documents = [
    (master_doc, 'PyformsGUI.tex', 'Pyforms GUI Documentation',
...
man_pages = [
    (master_doc, 'pyformsgui', 'Pyforms GUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyformsGUI', 'Pyforms GUI Documentation',
     author, 'PyformsGUI', 'One line description of project.',
     'Miscellaneous'),
]
